...
//          }
          ...
          for(int i = 0; i < sensor_fusion.size(); i++)
          {
            ...
            if(lane == 0)
              exist_car_left = true;
            if(lane == 2)
              exist_car_right = true;

            if(d < (4 + 4 * lane) && d > (4 * lane))
            {
              if((check_car_s > car_s) && (check_car_s - car_s < 30))
              {
                close_car_before = true;
                pre_car_speed = check_speed;
                //cout << check_speed << endl;
                cout << "close car before" << endl;
              }
            }
            else if(d < (4 * lane) && d > (4 * lane - 4))
            {
              car_left_sum++;
              if((check_car_s > car_s - 5) && (check_car_s - car_s < 40))
              {
                exist_car_left = true;
                cout << "left car exist" << endl;
              }
            }
            else if(d < (8 + 4 * lane) && d > (4 * lane + 4))
            {
              car_right_sum++;
              if((check_car_s > car_s - 5) && (check_car_s - car_s < 40))
              {
                exist_car_right = true;
                cout << "right car exist" << endl;
              }
            }
          }
          ...
          switch(result)
          {
            case 's':
              if(ref_vel > 0)
              {
                cout << car_speed - pre_car_speed << endl;
                ref_vel -= (car_speed - pre_car_speed)/100;
                //cout << "slow down" << endl;
              }
              break;
            case 'w':
